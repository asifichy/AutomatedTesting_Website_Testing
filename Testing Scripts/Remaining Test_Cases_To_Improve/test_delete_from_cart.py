...
def test_localhostLogin(username, password, i):
    ...
    driver.find_element(By.XPATH, "(//span[normalize-space()='$200'])[1]")
    
    #driver.find_element(By.XPATH, "(//div[@class='more-btn'])[1]")
    driver.find_element(By.XPATH, "(//form[@method='post'])[2]")
    driver.find_element(By.XPATH, "(//button[normalize-space()='delete all'])[1]").click()
    time.sleep(2)
